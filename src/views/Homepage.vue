<template>
  <div class="home-body">
    <div class="home-body-left">
      <div class="home-body-left-list">
        <ul>
          <li v-for="item in tableData" :key="item.subjectId">
            ...
            <div class="home-body-left-list-div">{{item.subjectType}}&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;{{item.subjectDifficulty}}&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;{{item.subjectReleaseTime}}</div>
            <div class="home-body-left-list-div">
      ...
      <div class="home-body-left-footer">
        <router-link to="/subject"><el-button>查看更多</el-button></router-link>
      </div>
    </div>
    <div class="home-body-right">
      <div class="home-body-right-card">
        <div class="home-body-right-card-title">关于本站</div>
        <el-divider></el-divider>
        <div class="home-body-right-card-content">致力于收集面试题目与题解，提供一站式面试备战交流服务，助你成为面试达人！</div>
      </div>
      <div class="home-body-right-list">
        <div>
          <div  class="home-body-right-card-title">适合程序员的网址推荐</div>
          <el-divider></el-divider>
          <div  class="home-body-right-website">
            <a href="https://www.bilibili.com/" target="_blank">
              <img src="../assets/bilibili.jpg" alt="">
              <span  class="home-body-right-card-content">海量教学资源在线免费观看</span>
            </a>
          </div>
          <el-divider></el-divider>
          <div  class="home-body-right-website">
            <a href="https://leetcode.cn/" target="_blank">
              <img src="../assets/力扣.jpeg" alt="">
              <span  class="home-body-right-card-content">海量技术面试题库,高效提升编程技能</span>
            </a>
          </div>
          <el-divider></el-divider>
          <div  class="home-body-right-website">
            <a href="https://www.nowcoder.com/" target="_blank">
              <img src="../assets/牛客.webp" alt="">
              <span  class="home-body-right-card-content">找工作神器,助你拿高薪OFFER</span>
            </a>
          </div>
          <el-divider></el-divider>
          <div  class="home-body-right-website">
            <a href="https://www.code-nav.cn/" target="_blank">
              <img src="../assets/编程导航.png" alt="">
              <span  class="home-body-right-card-content">专业全面的编程资源站点,不再求人！</span>
            </a>
          </div>
          <el-divider></el-divider>
        </div>
...
export default {
  ...
  mounted() {
    axios.get('http://localhost:8082/subjects')
      .then(response=>{
        this.tableData=response.data.data.slice(0,12)
      }).catch((error)=> {
      console.log(error);
    });
  },
...
.home-body-left ul li p {
  padding-top: 20px;
}

.home-body-left-list-div {
  padding-top: 20px;
}

.home-body-left-list-div-1 {
  float: left;
  margin-left: 10px;
}
.home-body-left-list-div-2 {
  float: left;
  margin-left: 35px;
}
.home-body-left-list-div-3 {
  float: left;
  margin-left: 35px;
}
.home-body-left-list-div-4 {
  float: left;
  margin-left: 35px;
}
...
.home-body-left-footer {
  float: left;
  padding:0 50%;
  padding-bottom: 30px;
}

.home-body-left-footer button {
...
.home-body-right-card {
  background-color: #FFF;
}

.home-body-right-card-title{
  padding-top: 20px;
  padding-left: 30px;
  font-size: 18px;
  color: black;
...
.home-body-right-list {
  margin-top: 30px;
  background-color: #fff;
}

.home-body-right-list img {
  height: 64px;
  width: 64px;
}

.home-body-right-website {
  padding-left: 30px;
}
